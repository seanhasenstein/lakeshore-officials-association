export function html({ url }: Record<'url', string>) {
  ...
  <html lang="en">
    <head>
      <title>Lakeshore Officials Sign-in</title>
              ...
              <tr>
                <td style="padding: 0 64px" class="mobile-padding">
                  ...
                  >
                    ...
                    <!-- Email Title -->
                    <tr>
                      <td style="padding: 0 0 32px; line-height: 1">
                        <h2
                          style="
                            margin: 0;
                            padding: 0;
                          ...
                          <tr>
                            ...
                            >
                              <p
                                ...
                                "
                              >
                                Here is the login link that you requested for the
                                Lakeshore Officials Association.
                              </p>
                            </td>
                          </tr>
