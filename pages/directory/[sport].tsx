...
export default function SportPage() {
  ...
  // setSport && setSelectedDate with sessionStorage
  React.useEffect(() => {
  ...
  // setFilteredUsers
  React.useEffect(() => {
    if (sportQuery.data && sport && dateIds) {
  ...
  }, [dateIds, filteredLevels, sport, sportQuery.data]);
  ...
  }, [sport, filteredLevels, selectedDate]);
