...
export default function ContactAdministrator() {
  ...
  return (
    <FullLayout title="Contact administrator">
      <ConctactAdminStyles>
        {status === 'success' ? (
          <div className="box success">
            ...
            <div>
              <h3>Message sent!</h3>
              <p>
                Thanks for reaching out. We&apos;ll be with you as soon as we
                can.
              </p>
            </div>
          </div>
          ...
          <>
            ...
            <p>
              This form is to report any problems that you are experiencing with
              the website.
            </p>
            <div className="box">
              <Formik
                ...
                onSubmit={async formValues => {
                  const response = await fetch('/api/contact-administrator', {
                    method: 'POST',
